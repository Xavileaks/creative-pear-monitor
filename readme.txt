...
El plugin reporta versiones, actualizaciones pendientes, administradores, PHP, presencia de formularios, estado reciente de wp_mail, configuración básica de WooCommerce y un resumen local de Defender. No envía contraseñas, claves de WPMU DEV, contenido de usuarios ni direcciones IP completas.
